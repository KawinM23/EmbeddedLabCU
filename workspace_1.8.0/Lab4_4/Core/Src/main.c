...
osThreadId messageThreadHandle;
...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
osPoolDef(mpool, 16, uint16_t);                    // Define memory pool
osPoolId  mpool;
/* USER CODE END 0 */
...
/* USER CODE BEGIN Header_StartmessageThread */
/**
* @brief Function implementing the messageThread thread.
* @param argument: Not used
* @retval None
*/
...
void StartmessageThread(void const * argument)
{
  ...
  /* USER CODE END StartmessageThread */
}
